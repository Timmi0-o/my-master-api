...
export const APPOINTMENT_CHAT_MESSAGE_RELATIONS: Record<
  string,
  RelationConfig
> = {
  chat: {
  ...
  attachments: {
    allowedSelectFields: [...APPOINTMENT_CHAT_MESSAGE_ATTACHMENT_SELECT_FIELDS],
    nested: {
      file: {
        allowedSelectFields: [
          ...APPOINTMENT_CHAT_MESSAGE_ATTACHMENT_FILE_SELECT_FIELDS,
...
export const APPOINTMENT_CHAT_MESSAGE_ATTACHMENTS_INCLUDE = {
  attachments: {
