...
export { ensureActorCanRescheduleAppointment } from './ensure-actor-can-reschedule-appointment.policy';
...
export { ensureAppointmentNoShowable } from './ensure-appointment-no-showable.policy';
export { ensureAppointmentReschedulable } from './ensure-appointment-reschedulable.policy';
...
} from './is-appointment-due-for-auto-complete';
