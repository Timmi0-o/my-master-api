...
import type { CallAuthenticatedSocket } from './call-authenticated-socket.types';

@Injectable()
export class CallWsJwtAuthGuard implements CanActivate {
  constructor(
  ...
  async canActivate(context: ExecutionContext): Promise<boolean> {
    const client = context.switchToWs().getClient<CallAuthenticatedSocket>();
